...
//                   className="w-full py-3 px-5 pr-12 rounded-l-md focus:outline-none"
//                 />
//                 <RiSearch2Line className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 text-xl" />
//               </div>
//               <button
//                 type="submit"
//                 className="bg-blue-600 text-white py-3 px-6 rounded-r-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
//               >
//                 Search
//               </button>
//             </form>
...
//               <Link href="/restaurants?cuisine=Italian" className="bg-white bg-opacity-20 text-white px-4 py-2 rounded-full hover:bg-opacity-30 transition">
//                 Italian
//               </Link>
//               <Link href="/restaurants?cuisine=Chinese" className="bg-white bg-opacity-20 text-white px-4 py-2 rounded-full hover:bg-opacity-30 transition">
//                 Chinese
//               </Link>
//               <Link href="/restaurants?cuisine=Indian" className="bg-white bg-opacity-20 text-white px-4 py-2 rounded-full hover:bg-opacity-30 transition">
//                 Indian
//               </Link>
//               <Link href="/restaurants?hasRooftop=true" className="bg-white bg-opacity-20 text-white px-4 py-2 rounded-full hover:bg-opacity-30 transition">
//                 Rooftop
//               </Link>
//               <Link href="/restaurants?hasAC=true" className="bg-white bg-opacity-20 text-white px-4 py-2 rounded-full hover:bg-opacity-30 transition">
//                 AC
//               </Link>
//             </div>
//           </div>
...
//             <Link href="/restaurants" className="text-blue-600 hover:underline font-medium">
//               View All
//             </Link>
//           </div>
...
//               <p className="text-gray-500">No featured restaurants available at the moment.</p>
//             </div>
//           )}
//         </div>
//       </section>
...
//                 <RiSearch2Line className="text-3xl text-blue-600" />
//               </div>
//               <h3 className="text-xl font-semibold mb-3">Search</h3>
//               <p className="text-gray-600">
//                 Find restaurants by location, cuisine, or amenities like rooftop seating or AC.
//               </p>
//             </div>
...
//             <div className="text-center">
//               <div className="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
//                 <RiFilterLine className="text-3xl text-blue-600" />
//               </div>
//               <h3 className="text-xl font-semibold mb-3">Choose</h3>
//               <p className="text-gray-600">
...
//           <h2 className="text-3xl font-bold mb-6">Own a Restaurant?</h2>
//           <p className="text-xl mb-8 max-w-2xl mx-auto">
//             Join CityEats to increase your visibility, streamline bookings, and grow your business.
//           </p>
//           <Link
//             href="/auth/vendor/signup"
//             className="inline-block bg-white text-blue-600 py-3 px-8 rounded-md font-medium hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white"
//           >
