...
// import { RiStarFill, RiMapPin2Line, RiTimeLine, RiPhoneLine, RiWifiLine, RiParkingBoxLine, RiSnowflakeLine } from 'react-icons/ri';
...
//           <div className="h-72 bg-gray-300 rounded-lg mb-8"></div>
//           <div className="h-10 bg-gray-300 w-1/3 rounded mb-4"></div>
...
//         </p>
//         <a href="/restaurants" className="text-blue-600 hover:underline">Back to all restaurants</a>
//       </div>
//     );
//   }
...
//           {images.length > 0 ? (
//             <Image
//               src={images[activeImage]?.imageUrl || '/images/restaurant-placeholder.jpg'}
//               alt={name}
//               fill
...
//               <div
//                 key={image.id}
//                 className={`relative w-20 h-20 rounded-md overflow-hidden cursor-pointer flex-shrink-0 ${
...
//           {hasAC && (
//             <div className="flex items-center">
//               <RiSnowflakeLine className="mr-2 text-blue-500" />
//               <span>AC</span>
//             </div>
//           )}
...
//           {hasRooftop && (
//             <div className="flex items-center">
//               <FaUmbrella className="mr-2 text-orange-500" />
//               <span>Rooftop</span>
//             </div>
//           )}
...
//           {hasParking && (
//             <div className="flex items-center">
//               <RiParkingBoxLine className="mr-2 text-purple-500" />
...
//                   <RiPhoneLine className="mr-2 text-gray-500" />
//                   <span>+1 (123) 456-7890</span>
//                 </div>
//                 <div className="flex items-center">
//                   <RiMapPin2Line className="mr-2 text-gray-500" />
//                   <span>{address}, {city}</span>
//                 </div>
//               </div>
//             </div>
...
//                             )}
//                           </div>
//                           <div className="text-gray-800 font-medium ml-4">
