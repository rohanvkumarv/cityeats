...
//           <h1 className="text-2xl font-bold mb-4">Restaurant Setup Required</h1>
...
//                 <RiImageAddLine className="text-4xl mb-2" />
...
//           <RiRestaurantLine className="text-6xl text-gray-300 mx-auto mb-4" />
//           <h3 className="text-xl font-medium text-gray-900 mb-2">Your menu is empty</h3>
