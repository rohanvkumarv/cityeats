...
//               formData.isOpen ? 'bg-green-200' : 'bg-red-200'
//             }`}>
...
//               <RiInformationLine className="text-blue-500 mr-2" size={20} />
...
//                 <div>
//                   <label htmlFor="openingHours" className="block text-sm text-gray-600 mb-1">
//                     Opening Time
//                   </label>
//                   <input
//                     type="time"
...
//                 </div>
//                 <div>
//                   <label htmlFor="closingHours" className="block text-sm text-gray-600 mb-1">
//                     Closing Time
//                   </label>
//                   <input
//                     type="time"
...
//                     className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
//                   />
//                   <label htmlFor="hasAC" className="ml-2 text-gray-700">
//                     Air Conditioning
//                   </label>
//                 </div>
...
//                     className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
//                   />
//                   <label htmlFor="hasRooftop" className="ml-2 text-gray-700">
//                     Rooftop Seating
//                   </label>
//                 </div>
...
//                     className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
//                   />
//                   <label htmlFor="hasWifi" className="ml-2 text-gray-700">
//                     Free WiFi
//                   </label>
//                 </div>
...
//                     className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
//                   />
//                   <label htmlFor="hasParking" className="ml-2 text-gray-700">
//                     Parking Available
//                   </label>
//                 </div>
//               </div>
...
//             <div className="flex justify-between items-center mb-6">
//               <div className="flex items-center">
//                 <RiRestaurantLine className="text-blue-500 mr-2" size={20} />
...
//               </div>
//             ) : (
//               <div className="text-center py-8 mb-6 border-2 border-dashed border-gray-300 rounded-md">
//                 <RiRestaurantLine className="mx-auto h-12 w-12 text-gray-400" />
//                 <h3 className="mt-2 text-sm font-medium text-gray-900">No tables added</h3>
...
//                 <h3 className="font-medium mb-3">Add New Table</h3>
...
//                       className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
//                     />
//                     <label htmlFor="newTableHasAC" className="ml-2 text-sm text-gray-700">
...
//           <div className="bg-white rounded-lg shadow-md p-6 mb-6">
//             <div className="mb-6 flex items-center">
//               <RiImageAddLine className="text-blue-500 mr-2" size={20} />
//               <h2 className="text-lg font-semibold">Restaurant Images</h2>
//             </div>
            
//             {/* Image upload section (coming soon) */}
//             <div className="border-2 border-dashed border-gray-300 rounded-md p-6 flex flex-col items-center justify-center text-gray-500 mb-6">
//               <RiImageAddLine className="text-5xl mb-3" />
//               <p className="mb-2 font-medium">Image upload functionality coming soon</p>
