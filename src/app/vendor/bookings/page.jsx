...
// //         <h1 className="text-2xl font-bold mb-4 md:mb-0">Bookings</h1>
...
// //           <RiFilter2Line className="text-gray-500 mr-2" />
...
// //                 className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
// //               />
// //               <RiCalendarLine className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 pointer-events-none" />
// //             </div>
// //           </div>
...
// //                     </td>
// //                     <td className="px-6 py-4 whitespace-nowrap">
// //                       <div className="text-sm text-gray-900">{booking.people} people</div>
// //                       <div className="text-sm text-gray-500">
// //                         {booking.table.type} {booking.table.hasAC ? '(AC)' : '(Non-AC)'}
// //                       </div>
// //                       {booking.order && (
// //                         <div className="text-xs text-blue-600 mt-1">Has food pre-order</div>
// //                       )}
// //                     </td>
// //                     <td className="px-6 py-4 whitespace-nowrap">
...
// //             <RiCalendarLine className="text-5xl text-gray-300 mb-4" />
...
//                     <RiUser3Line className="mr-2 text-blue-500" />
//                     Customer Information
//                   </h3>
...
//                         <p className="font-medium">{formatDateTime(selectedBooking.date)}</p>
//                       </div>
//                     </div>
...
//                         <p className="font-medium">{selectedBooking.people} {selectedBooking.people === 1 ? 'person' : 'people'}</p>
//                       </div>
//                     </div>
...
//                   <div className="mb-6 p-4 bg-gray-50 rounded-lg">
//                     <h3 className="font-semibold mb-3 flex items-center">
//                       <RiInformationLine className="mr-2 text-blue-500" />
//                       Special Requests
//                     </h3>
...
//                   <div className="mb-6 p-4 bg-gray-50 rounded-lg">
//                     <h3 className="font-semibold mb-3 flex items-center">
//                       <RiRestaurantLine className="mr-2 text-blue-500" />
//                       Food Pre-order
//                     </h3>
//                     <div className="overflow-x-auto">
//                       <table className="min-w-full divide-y divide-gray-200">
...
//                                 <div className="text-sm text-gray-500">{item.menuItem.category}</div>
//                               </td>
...
//                               Total:
//                             </td>
//                             <td className="px-4 py-2 font-medium text-right text-blue-600">
...
//                         <span className="text-green-600 font-medium">Pre-order has been paid</span> : 
//                         <span className="text-yellow-600 font-medium">Payment will be collected at restaurant</span>
//                       }
//                     </div>
//                   </div>
//                 )}
