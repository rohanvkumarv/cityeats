...
//         <p className="mb-6">You need to be logged in to access your account.</p>
//         <Link
//           href="/auth/login"
...
//           className="md:hidden bg-white p-2 rounded-md shadow-md mb-4 self-start"
//         >
//           {isMobileSidebarOpen ? (
//             <RiCloseLine className="text-xl" />
//           ) : (
//             <div className="flex items-center">
//               <RiMenuLine className="text-xl mr-2" />
...
//           <h2 className="font-bold text-lg px-4 mb-4">My Account</h2>
//           <nav className="space-y-1">
//             {navItems.map((item) => (
//               <Link
//                 key={item.name}
