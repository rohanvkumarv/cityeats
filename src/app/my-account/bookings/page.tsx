...
//               <h3 className="text-xl font-bold mb-2">{booking.restaurant.name}</h3>
...
//                 <RiCalendarEventLine className="mt-1 mr-2 text-blue-500" />
//                 <div>
...
//               <div className="flex items-start">
//                 <RiTimeLine className="mt-1 mr-2 text-blue-500" />
//                 <div>
...
//               <div className="flex items-start">
//                 <RiUserLine className="mt-1 mr-2 text-blue-500" />
//                 <div>
...
//               <div className="flex items-start">
//                 <RiRestaurantLine className="mt-1 mr-2 text-blue-500" />
//                 <div>
...
//                 <h4 className="font-medium mb-2">Pre-ordered Food</h4>
...
//           <RiCalendarEventLine className="text-5xl text-gray-300 mx-auto mb-4" />
